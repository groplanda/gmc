...
mix.setPublicPath('./themes/gmc/assets');
mix.js('./themes/gmc/assets/src/app.js', 'dist/js')
  .sass('./themes/gmc/assets/src/app.scss', 'dist/css')
  .options({
    postCss: [
      require('postcss-url'),
  ...
  .browserSync({
    ...
    notify: false,
    files: [
      "./themes/gmc/assets/dist/css/*.css",
      "./themes/gmc/assets/dist/js/*.js",
      "./themes/gmc/**/*.htm",
    ]
});
